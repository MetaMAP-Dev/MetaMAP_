    ...
    <div className="flex flex-col bg-white">
      ...
      <section className="py-32 bg-neutral-50/50">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              { icon: Globe, title: "Urban Planning", desc: "District-scale massing studies and density visualization.", color: "emerald" },
              { icon: Zap, title: "Environmental", desc: "Solar potential and shadowing analysis with high accuracy.", color: "blue" },
              { icon: BarChart3, title: "Microclimate", desc: "Seamless geometry for Eddy3D, Butterfly, and more.", color: "indigo" }
            ].map((card, i) => (
      ...
      <section className="py-32 bg-white">
        <div className="max-w-5xl mx-auto px-4 text-center">
          ...
          <div className="mt-20">
            <a href="https://github.com/metamap-org" target="_blank" rel="noopener noreferrer" className="inline-flex items-center space-x-3 px-8 py-4 bg-neutral-900 hover:bg-black text-white rounded-full font-bold shadow-lg transition-all">
              <Github size={20} />
